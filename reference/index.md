...
Define schemas and coerce and validate data against them.
...
- [`sch_schema()`](http://corymccartan.com/schemar/reference/sch_schema.md)
  ...
  [`sch_any()`](http://corymccartan.com/schemar/reference/sch_schema.md)
...
- [`sch_coerce()`](http://corymccartan.com/schemar/reference/sch_coerce.md)
